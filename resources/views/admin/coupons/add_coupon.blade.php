      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{route('admin.coupon.add')}}" name="add_coupon" id="add_coupon" >
             @csrf
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <select type="text" name="amount_type" id="amount_type" style="width: 220px">
