        ...
        <div class="col-sm-8">
          <div class="shop-menu pull-right">
            <ul class="nav navbar-nav">
              ...
              <li><a href="{{route('cart')}}"><i class="fa fa-shopping-cart"></i> Cart ({{ $cartCount}})</a></li>
              @if(empty(Auth::check()))
              <li><a href="{{route('user.register')}}"><i class="fa fa-lock"></i> Login</a></li>
              @else
              <li><a href="{{route('user.user_account')}}"><i class="fa fa-user"></i> Account</a></li>
              <li><a href="{{route('user.user_logout')}}"><i class="fa fa-sign-out"></i> Logout</a></li>
              @endif
            </ul>
          </div>
        </div>
